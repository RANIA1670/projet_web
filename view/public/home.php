...
<div class="site-shell">
  ...
  <main class="page public-page">
    <section class="hero">
      ...
      <p class="hero-copy">Signalez un incident, votez pour un projet, suivez l'etat de votre quartier. Le <a href="<?= htmlspecialchars(cityzen_asset('controller/index.php')) ?>">portail municipal</a> prolonge ces services.
        <?php if (cityzen_is_agent()): ?>
          Le <a href="<?= htmlspecialchars(cityzen_asset('controller/dashboard.php')) ?>">tableau de bord back-office</a> est disponible pour votre session.
        <?php else: ?>
          L'<a href="<?= htmlspecialchars(cityzen_login_url(cityzen_asset('controller/dashboard.php'))) ?>">espace agents</a> (connexion) permet d'acceder au back-office.
        <?php endif; ?>
      </p>
    ...
    <section class="feed-section" id="signalements">
      <div class="section-header">
        ...
        <div class="section-header-links">
          <a href="<?= htmlspecialchars(cityzen_asset('controller/index.php')) ?>">Portail municipal</a>
          <?php if (cityzen_is_agent()): ?>
            <span class="section-header-sep" aria-hidden="true">|</span>
            <a href="<?= htmlspecialchars(cityzen_asset('controller/dashboard.php')) ?>">Vue agents</a>
          <?php else: ?>
            <span class="section-header-sep" aria-hidden="true">|</span>
