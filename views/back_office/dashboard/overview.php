...
<form method="POST" action="index.php?page=dashboard" id="dashboardBulkForm">
            ...
            if ($latestPosts) {
                foreach ($latestPosts as $post) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="index.php?page=edit_post&id=<?= (int)$post->getId() ?>" class="action-btn" style="display:inline-block;text-decoration:none;text-align:center;">✏️ Éditer</a>
                            <form method="POST" action="index.php?page=dashboard" style="display:inline;" onsubmit="return confirm('Supprimer ce post ?')">
                                <input type="hidden" name="action" value="delete_post">
