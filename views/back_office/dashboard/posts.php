...
<div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);padding:16px 20px;margin-bottom:16px;display:flex;gap:12px;align-items:center;">
    <form method="GET" style="display:flex;gap:10px;width:100%;align-items:center;">
        ...
        <?php if ($searchQuery !== ''): ?>
            <a href="index.php?page=posts" class="action-btn" style="text-decoration:none;text-align:center;">✕ Effacer</a>
        <?php endif; ?>
    </form>
</div>

<!-- Bulk action bar -->
<form method="POST" action="index.php?page=posts" id="bulkForm">
