...
<form method="GET" action="index.php" style="display:grid;grid-template-columns:repeat(5,minmax(160px,1fr));gap:12px;align-items:flex-end;margin-bottom:18px;">
...
<table>
    <thead>
        <tr>
            <th>#</th><th>Participant</th><th>Email</th><th>Événement</th><th>Actions</th>
        </tr>
    </thead>
    <tbody>
        <?php if (empty($participations)): ?>
            <tr><td colspan="5" style="color:#aaa;">Aucune participation.</td></tr>
        <?php else: ?>
