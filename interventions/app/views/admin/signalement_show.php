<div class="admin-container container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4 gap-3 flex-wrap">
        <div>
            <a href="<?= APP_URL ?>/backoffice/signalements" class="btn btn-sm btn-outline-secondary mb-2"><i class="fas fa-arrow-left"></i> Retour aux signalements</a>
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a href="<?= APP_URL ?>/backoffice/intervention/creer?signalement_id=<?= $signalement['id'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-tools"></i> Créer une intervention</a>
            <a href="<?= APP_URL ?>/backoffice/signalements" class="btn btn-sm btn-outline">Fermer</a>
        </div>
    </div>
