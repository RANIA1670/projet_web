...
<aside class="admin-sidebar" id="adminSidebar">
    ...
    <div class="sidebar-footer">
        ...
        <a href="<?= $citizenLogoutHref ?>" class="btn-logout">
            <i class="fas fa-sign-out-alt"></i> Déconnexion CityZen
        </a>
        <a href="<?= $citizenPortalHref ?>" class="btn-front" style="margin-top:6px;">
            <i class="fas fa-sign-in-alt"></i> Portail CityZen
        </a>
    </div>
</aside>
