<div class="admin-container container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div>
            <a href="<?= APP_URL ?>/admin" class="btn btn-sm btn-outline-secondary"><i class="fas fa-arrow-left"></i> Retour au tableau de bord</a>
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a href="<?= APP_URL ?>/admin/intervention/creer" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Nouvelle intervention</a>
        </div>
    </div>
    ...
    <div class="table-responsive bg-white rounded shadow-sm">
        <table class="table admin-table mb-0">
            <thead>
                <tr>
                    <th><a href="<?= APP_URL ?>/admin/interventions?<?= http_build_query(array_merge($_GET, ['sort' => 'id', 'direction' => $sort === 'id' && $direction === 'ASC' ? 'DESC' : 'ASC'])) ?>">ID</a></th>
                    <th><a href="<?= APP_URL ?>/admin/interventions?<?= http_build_query(array_merge($_GET, ['sort' => 'created_at', 'direction' => $sort === 'created_at' && $direction === 'ASC' ? 'DESC' : 'ASC'])) ?>">Création</a></th>
                    <th><a href="<?= APP_URL ?>/admin/interventions?<?= http_build_query(array_merge($_GET, ['sort' => 'date_planifiee', 'direction' => $sort === 'date_planifiee' && $direction === 'ASC' ? 'DESC' : 'ASC'])) ?>">Date prévue</a></th>
                    <th>Signalement</th>
                    <th><a href="<?= APP_URL ?>/admin/interventions?<?= http_build_query(array_merge($_GET, ['sort' => 'technicien_nom', 'direction' => $sort === 'technicien_nom' && $direction === 'ASC' ? 'DESC' : 'ASC'])) ?>">Technicien</a></th>
                    <th><a href="<?= APP_URL ?>/admin/interventions?<?= http_build_query(array_merge($_GET, ['sort' => 'statut', 'direction' => $sort === 'statut' && $direction === 'ASC' ? 'DESC' : 'ASC'])) ?>">Statut</a></th>
                    <th>Actions</th>
                </tr>
            </thead>
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= APP_URL ?>/admin/intervention/<?= $inv['id'] ?>" class="text-decoration-none fw-bold">
                        ...
                        <td>
                            <div class="d-flex gap-1 flex-wrap">
                                <a href="<?= APP_URL ?>/admin/intervention/<?= $inv['id'] ?>" class="btn btn-sm btn-outline-primary" title="Voir"><i class="fas fa-eye"></i></a>
                                <a href="<?= APP_URL ?>/admin/intervention/<?= $inv['id'] ?>/edit" class="btn btn-sm btn-outline-secondary" title="Modifier"><i class="fas fa-pencil-alt"></i></a>
    ...
    <div class="pagination-section mt-4 d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <div class="pagination-buttons">
            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                <a href="<?= APP_URL ?>/admin/interventions?<?= http_build_query(array_merge($_GET, ['page' => $i])) ?>" class="btn btn-sm <?= $i === $currentPage ? 'btn-primary' : 'btn-outline-secondary' ?>"><?= $i ?></a>
            <?php endfor; ?>
        </div>
    </div>
</div>
