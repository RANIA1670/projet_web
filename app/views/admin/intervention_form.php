<div class="admin-container container py-5">
    ...
    <div class="bg-white rounded shadow-sm p-4">
        ...
        <form method="POST" action="<?= $action === 'edit' ? APP_URL . '/admin/intervention/' . $intervention['id'] . '/edit' : APP_URL . '/admin/intervention/creer' ?>">
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-12 d-flex gap-2">
                    ...
                    <a href="<?= APP_URL ?>/admin/interventions" class="btn btn-outline-secondary">Annuler</a>
                </div>
            </div>
        </form>
    </div>
