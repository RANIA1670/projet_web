<div class="admin-dashboard-container">
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            ...
            <a href="<?= APP_URL ?>/admin/export-pdf" target="_blank" class="btn btn-primary">
                    ...
                    <table class="table admin-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= APP_URL ?>/admin/signalement/<?= htmlspecialchars($sig['id'] ?? '') ?>" class="btn btn-sm btn-outline"><i class="fas fa-eye"></i> Voir</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    ...
                    <table class="table admin-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= APP_URL ?>/admin/intervention/<?= htmlspecialchars($inv['id'] ?? '') ?>" class="btn btn-sm btn-outline"><i class="fas fa-eye"></i> Voir</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
