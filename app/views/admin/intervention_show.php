<div class="admin-container container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <a href="<?= APP_URL ?>/admin/interventions" class="btn btn-sm btn-outline-secondary"><i class="fas fa-arrow-left"></i> Retour aux interventions</a>
        </div>
        <div>
            <a href="<?= APP_URL ?>/admin" class="btn btn-sm btn-outline-success">Dashboard admin</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded shadow-sm p-4">
        ...
        <div class="mt-4">
            <a href="<?= APP_URL ?>/admin/intervention/<?= $intervention['id'] ?>/edit" class="btn btn-primary btn-sm"><i class="fas fa-pencil-alt"></i> Modifier l'intervention</a>
            <form action="<?= APP_URL ?>/admin/intervention/<?= $intervention['id'] ?>/supprimer" method="POST" class="d-inline" onsubmit="return confirm('Supprimer cette intervention ?');">
