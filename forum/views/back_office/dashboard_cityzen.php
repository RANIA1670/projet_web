...
if ($currentUserId === 0 || !$isAdmin) {
    header('Location: ' . forum_list_url('page=home'), true, 302);
    exit;
}
                ...
                <?php foreach ($openReports as $report): ?>
                    <tr style="border-bottom: 1px solid #E8ECF0;">
                        ...
                        <td style="padding: 12px 20px; text-align: right; display: flex; gap: 8px; justify-content: flex-end;">
                            <form method="POST" action="<?= htmlspecialchars(forum_admin_nav_base(), ENT_QUOTES, 'UTF-8') ?>?page=dashboard" style="display:inline;">
                            ...
                            <form method="POST" action="<?= htmlspecialchars(forum_admin_nav_base(), ENT_QUOTES, 'UTF-8') ?>?page=dashboard" style="display:inline;" onsubmit="return confirm('Supprimer ce post définitivement ?');">
